...
<template>
    <q-page class="q-pa-md director-page">
        ...
        <div class="header-container q-mb-lg">
            ...
            >
                <q-btn
                    label="Ver Lista de Repertorio"
                    color="secondary"
                    @click="goToListaRepertorio"
                    class="gestion-repertorio-btn"
                    icon="library_music"
                    unelevated
                    aria-label="Ver Lista de Repertorio"
                />
                <q-btn
                    label="Agregar Nuevo Repertorio"
                    color="accent"
                    @click="goToAgregarRepertorio"
                    icon="add"
                    unelevated
                    aria-label="Agregar Nuevo Repertorio"
                />
            ...
            <q-card class="shadow-2 rounded-borders" style="min-width: 350px">
                ...
                <q-card-actions align="right">
                    <q-btn
                        ...
                        aria-label="Cerrar Solicitudes Pendientes"
                    />
                </q-card-actions>
            </q-card>
        </q-dialog>

        <!-- Componente ListaRepertorio -->
        <ListaRepertorio />
    </q-page>
</template>
...
import ListaRepertorio from "../components/ListaRepertorio.vue"; // Componente de lista de repertorio
...
const goToListaRepertorio = () => {
    router.push({ name: "ListaRepertorio" });
};

const goToAgregarRepertorio = () => {
    router.push({ name: "AgregarRepertorio" });
};
